...
const projectsData = [
  {
    id: 0,
    title: "ProfitSword",
    appImage: profitSwordImage.src,
    techStack: "Angular 18 | NgRx | .NET | Azure",
    description:
      "Premier hotel business intelligence software chosen by top hoteliers for its ability to streamline operations and enhance decision-making. Converting legacy application from Vue, XML, Vanilla JavaScript to modern Angular 18 framework with .NET backend.",
    tags: ["Web App"],
  },
  {
    id: 1,
    ...
    description:
      "This is a highly performant and accessible website that was built utilizing NextJS, Material UI & Headless WordPress. It caches data with Cloudflare and deployed with Vercel using CI/CD to ensure the latest code is deployed. The website empowers veterans to to leverage resources and services to gain quality medical evidence to win VA disability claims.",
  ...
  {
    id: 3,
    title: "Constant Guardian",
    appImage: constantGuardianImage.src,
    techStack: "Electron | React | TailwindCSS | C++ | Python",
    description:
      "This is a confidential project that was built using Electron, React, TailwindCSS, C++ & Python. The CI/CD process is taken care of with Azure. The application is a desktop application that processes and renders realtime data.",
    liveLink: "https://constantguardian.com/",
  ...
  },
  {
    ...
    gitURL:
      "https://github.com/timtran007/phase-3-project-dog-adventures-client",
    tags: ["All", "Web App"],
  },
  {
    id: 8,
